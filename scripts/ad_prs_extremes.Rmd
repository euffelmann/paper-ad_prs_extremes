...
Here we show that defining a phenotype based on the extremes of a PRS-distribution, and then running a GWAS on this newly-defined phenotype leads to strongly inflated false positive rates. This is because one effectively regresses the dependent variable on itself. In other words, SNPs used to predict the dependent variable were used to define it. 
...
gt_tbl <- fpr_prs_0.05_sig_gws_table %>%
  ...
  #gtsave(filename = "random/ad_prs_extremes/tables/prs_threshold0.05_fpr_threshold5e-08.html", inline_css = TRUE)
